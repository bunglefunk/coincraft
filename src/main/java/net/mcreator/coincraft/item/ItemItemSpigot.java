...
public class ItemItemSpigot extends ElementsCoinCraft.ModElement {
	@GameRegistry.ObjectHolder("coincraft:itemspigot")
	public static final Item block = null;
	public ItemItemSpigot(ElementsCoinCraft instance) {
		super(instance, 3);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("coincraft:itemspigot", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 64;
			setUnlocalizedName("itemspigot");
			setRegistryName("itemspigot");
