...
package net.mcreator.coincraft.gui;
...
public class GuiCastIronFurnaceGUI extends ElementsCoinCraft.ModElement {
	public static int GUIID = 2;
	public static HashMap guistate = new HashMap();
	public GuiCastIronFurnaceGUI(ElementsCoinCraft instance) {
		super(instance, 57);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 17, 20) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 53, 20) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 35, 56) {
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 125, 38) {
				@Override
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				CoinCraft.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("coincraft:textures/castironfurnacegui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Cast Iron Furnace", 4, 5, -13421773);
		}
		...
		protected void actionPerformed(GuiButton button) {
			CoinCraft.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
