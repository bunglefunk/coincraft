...
public class BlockCastIronFurnaceOn extends ElementsCoinCraft.ModElement {
	@GameRegistry.ObjectHolder("coincraft:castironfurnaceon")
	public static final Block block = null;
	public BlockCastIronFurnaceOn(ElementsCoinCraft instance) {
		super(instance, 59);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("castironfurnaceon"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "coincraft:tileentitycastironfurnaceon");
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("coincraft:castironfurnaceon", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		public static final PropertyDirection FACING = BlockHorizontal.FACING;
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("castironfurnaceon");
		...
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
			return new ItemStack(BlockCastIronFurnaceOff.block, (int) (1));
		}
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(BlockCastIronFurnaceOff.block, (int) (1)));
		}
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return "container.castironfurnaceon";
		}
		...
		public String getGuiID() {
			return "coincraft:castironfurnaceon";
		}
